// Xinwu E action symbols: compact ink outlines paired with hardware stickers.
// A 24-unit canvas, 2-unit round strokes, with open device-like enclosures.
export const icons = {
  ...
  search: { label: '搜索', group: 'action', meaning: '按产品名称或用途查找', paths: ['M17 10a7 7 0 1 1-14 0 7 7 0 0 1 14 0ZM15 15l5.5 5.5'] },
  menu: { label: '菜单', group: 'action', meaning: '展开网站导航', paths: ['M4 6h16M4 12h16M4 18h16'] },
  ...
  article: { label: '产品介绍', group: 'content', meaning: '阅读图文资料，不能用作实测认证', paths: ['M14 3.5H6.5a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V9L14 3.5ZM14 3.5V9h5.5M8.5 13h7M8.5 16.5h7'] },
